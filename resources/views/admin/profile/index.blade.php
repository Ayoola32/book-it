                        ...
                        <div class="card-body box-profile text-center">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Last Logged In</b> <span class="float-end">5 seconds ago</span>
                                </li>
                                <li class="list-group-item">
                                    <b>Account Created</b> <span class="float-end">1 day ago</span>
                                </li>
                                <li class="list-group-item">
                                    <b>Role</b> <span class="float-end">Admin</span>
                                </li>
                            </ul>
                        </div>
                    </div>
